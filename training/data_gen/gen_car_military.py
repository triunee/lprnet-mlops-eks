# num_img = 7 | 예상 생성량: 27 × 7 = 189장 → result33/
import os
import random
import uuid
...
if __name__ == '__main__':
    ...
    if not os.path.exists('./result33'):
        os.mkdir('./result33')
    if not os.path.exists('./result33/images'):
        os.mkdir('./result33/images')
    if not os.path.exists('./result33/labels'):
        os.mkdir('./result33/labels')

    Type_A1 = ImageGenerator(save_dir='./result33/',
                             plates_dir='./assets/plates/type_a',
                             nums_dir='./assets/nums/',
                             chars_dir='./assets/chars_m/')

    Type_B1 = ImageGenerator(save_dir='./result33/',
